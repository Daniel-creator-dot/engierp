...
export async function seed(knex: Knex): Promise<void> {
  ...
  // Seed Users ($2b$10$/gjDIB.MDV4xYW1nM5NT2u3bp8kOoq6y6yNn.qLCjXXo2Q118kk4q is 'password123')
  await knex("users").insert([
    { email: 'admin@engierp.com', password: '$2b$10$/gjDIB.MDV4xYW1nM5NT2u3bp8kOoq6y6yNn.qLCjXXo2Q118kk4q', role: 'admin' },
    { email: 'hr@engierp.com', password: '$2b$10$/gjDIB.MDV4xYW1nM5NT2u3bp8kOoq6y6yNn.qLCjXXo2Q118kk4q', role: 'hr', employee_id: 'EMP-002' },
    { email: 'acc@engierp.com', password: '$2b$10$/gjDIB.MDV4xYW1nM5NT2u3bp8kOoq6y6yNn.qLCjXXo2Q118kk4q', role: 'accountant' },
    { email: 'pm@engierp.com', password: '$2b$10$/gjDIB.MDV4xYW1nM5NT2u3bp8kOoq6y6yNn.qLCjXXo2Q118kk4q', role: 'pm', employee_id: 'EMP-002' },
    { email: 'proc@engierp.com', password: '$2b$10$/gjDIB.MDV4xYW1nM5NT2u3bp8kOoq6y6yNn.qLCjXXo2Q118kk4q', role: 'procurement' },
  ]);
  ...
  await knex("projects").insert([
    ...
    { id: 'PRJ-003', name: 'Metro Tunnel Expansion', client: 'Transport Authority', budget: 8500000, spent: 8200000, status: 'on-hold', startDate: '2022-03-01', endDate: '2024-12-20', manager: 'Mike Ross', profitability: 12 },
  ]);

  // Seed Transactions
  await knex("transactions").insert([
    { id: 'TX-001', date: '2024-04-01', description: 'Cement Supply - Batch A', category: 'Materials', amount: 15000, type: 'expense', status: 'cleared', project_id: 'PRJ-001' },
    { id: 'TX-002', date: '2024-04-02', description: 'Consultancy Fee - Design', category: 'Professional Services', amount: 5000, type: 'expense', status: 'cleared', project_id: 'PRJ-001' },
    { id: 'TX-003', date: '2024-04-05', description: 'Progress Payment #4', category: 'Revenue', amount: 250000, type: 'income', status: 'cleared', project_id: 'PRJ-001' },
  ...
  await knex("invoices").insert([
    ...
    { id: 'INV-1003', client: 'Transport Authority', amount: 120000, dueDate: '2024-03-30', status: 'overdue', project_id: 'PRJ-003' },
  ]);
