...
export type Module = 
  | 'dashboard' 
  | 'accounting-gl' | 'accounting-ar' | 'accounting-ap' | 'accounting-tax' | 'accounting-bank' | 'accounting-transactions' | 'accounting-reports' | 'accounting-coa' | 'accounting-foundation'
