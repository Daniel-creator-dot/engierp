  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full bg-[#1e293b] text-white">
      <div className="p-6 flex items-center gap-3">
        ...
        <span className="font-bold text-xl tracking-tight truncate">EngiERP</span>
      </div>
    ...
    <div className="flex h-screen bg-[#F5F5F5] text-[#141414] font-sans">
      ...
      >
        <div className="p-6 flex items-center gap-3">
          ...
          {isSidebarOpen && <span className="font-bold text-xl tracking-tight truncate">EngiERP</span>}
        </div>
